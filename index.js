...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝗢𝗹𝗮̀ @${num.split('@')[0]}^-^\n𝗕𝗲𝗺 𝘃𝗶𝗻𝗱𝗼 𝗮𝗼 𝗴𝗿𝘂𝗽𝗼 ${mdata.subject}\n❛❛𝗗𝗶𝗴𝗶𝘁𝗲 /𝗿𝗲𝗴𝗿𝗮𝘀 𝗽𝗮𝗿𝗮 𝗹𝗲𝗿 𝗮𝘀 𝗿𝗲𝗴𝗿𝗮𝘀 𝗲 𝗻𝗮̃𝗼 𝘀𝗲𝗿 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗼 𝗱𝗼 𝗴𝗿𝘂𝗽𝗼❜❜\n️❛❛𝗖𝗮𝘀𝗼 𝘁𝗲𝗻𝗵𝗮 𝗲𝗻𝘁𝗿𝗮𝗱𝗼 𝗲𝗺 𝗮𝗹𝗴𝘂𝗺𝗮 𝗿𝗲𝗰𝗿𝘂𝘁𝗮 𝗱𝗮 𝗿𝗮𝗶𝗼, 𝗲 𝗻𝗮𝗼 𝘀𝗮𝗯𝗲 𝗼 𝗾𝘂𝗲 𝗳𝗮𝘇𝗲𝗿 𝗱𝗮 𝘃𝗶𝗱𝗮, 𝗱𝗶𝗴𝗶𝘁𝗮 /𝗮𝘁𝗮𝗾𝘂𝗲❜❜\n❛❛𝗗𝗶𝗴𝗶𝘁𝗲 /𝘁𝗮𝗴, 𝗲 𝘂𝘀𝗲 𝗮 𝘁𝗮𝗴 𝗻𝗼 𝘀𝗲𝘂 𝗻𝗼𝗺𝗲, 𝗰𝗮𝘀𝗼 𝗰𝗼𝗻𝘁𝗿𝗮𝗿𝗶𝗼 𝘀𝗲𝗿𝗮́ 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗼❜❜`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '𝗘𝘀𝗽𝗲𝗿𝗲 𝘂𝗺 𝗽𝗼𝘂𝗰𝗼... 𝘁𝗼𝗺𝗲 𝘂𝗺 𝗰𝗮𝗳𝗲́ 𝗲𝗻𝗾𝘂𝗮𝗻𝘁𝗼 𝗶𝘀𝘀𝗼 ☕...',
					success: '️❬ ✔ ❭ Sucesso 🖤',
			...
			const premium = ["5511911219615@s.whatsapp.net","17198903218@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`❛❛❗𝗟𝗶𝗻𝗸 𝗱𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼❗\n𝗢 ${sender.split("@")[0]} 𝘀𝗲𝗿𝗮 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗼 𝗲𝗺 3 𝘀𝗲𝗴𝘂𝗻𝗱𝗼𝘀❜❜`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 3000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("1 𝘀𝗲𝗴𝘂𝗻𝗱𝗼...\n 𝗡𝗶𝗴𝘂𝗲𝗺 𝗺𝗮𝗻𝗱𝗼𝘂 𝗻𝗮̃𝗼 𝗹𝗲𝗿 𝗮𝘀 𝗿𝗲𝗴𝗿𝗮𝘀, 𝗯𝘆𝗲 𝗯𝘆𝗲")
		}, 2000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("2 𝘀𝗲𝗴𝘂𝗻𝗱𝗼𝘀...")
		...
		if (!isGroup) return
		if (!isAntiLink) return
		if (isGroupAdmins) return reply('❗𝙉𝙪𝙢𝙚𝙧𝙤 𝘿𝙚𝙩𝙚𝙘𝙩𝙖𝙙𝙤❗\n𝗟𝗶𝗯𝗲𝗿𝗮𝗱𝗼, 𝘃𝗰 𝗲́ 𝘂𝗺 𝗮𝗱𝗺✅')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`❛❛❗𝙉𝙪𝙢𝙚𝙧𝙤 𝘿𝙚𝙩𝙚𝙘𝙩𝙖𝙙𝙤❗\n𝗢 ${sender.split("@")[0]} 𝘀𝗲𝗿𝗮 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗼 𝗲𝗺 3 𝘀𝗲𝗴𝘂𝗻𝗱𝗼𝘀❜❜`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 3000)
		setTimeout( () => {
...
break
				...
				case 'baixarvid':
					...
					teks = `📍𝗧𝗜𝗧𝗨𝗟𝗢: ${anu.title}\n📍𝗔𝗴𝘂𝗮𝗿𝗱𝗲 𝗼 𝗱𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗱𝗼 𝘃𝗶𝗱𝗲𝗼...`
...
//@nabutoYT					
    ...
    break
		        ...
		        case 'wame':
                  client.updatePresence(from, Presence.composing) 
                  options = {
                  text: `𝗢𝗹𝗮́ @${sender.split("@s.whatsapp.net")[0]} 𝗦𝗲𝘂 𝗹𝗶𝗻𝗸 𝗱𝗼 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 𝗲́ 𝗲𝘀𝘀𝗲:\nhttps://wa.me/${sender.split("@s.whatsapp.net")[0]} \n𝗢𝘂\nhttps://api.whatsapp.com/send?phone=${sender.split("@")[0]}`,
                  contextInfo: { mentionedJid: [sender] }
                  }
           ...
           case 'playmp3':
            ...
            case 'smule':
                ...
                case 'pinterest':
					...
					nimek =  n[Math.floor(Math.random() * n.length)];
					pok = await getBuffer(nimek)
					client.sendMessage(from, pok, image, { quoted: mek, caption: `❛❛𝗥𝗲𝘀𝘂𝗹𝘁𝗮𝗱𝗼 𝗱𝗮 𝗽𝗲𝘀𝗾𝘂𝗶𝘀𝗮 𝗻𝗼 𝗽𝗶𝗻𝘁𝗲𝗿𝗲𝘀𝘁: ${tels}❜❜`})
                    await limitAdd(sender)
					break
                case 'memes2':
				 data = fs.readFileSync('./src/nabutojokes.js');
...
break
				...
				break 
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from,`🤔𝗠𝗔𝗡𝗗𝗢𝗨 𝗟𝗜𝗡𝗞?\n𝗕𝗮𝗻 𝗲𝗺 3 𝘀𝗲𝗴𝘂𝗻𝗱𝗼𝘀♥️`, text)
					} else if (Number(args[0]) === 0) {
				...
				case 'wibu':
                   ...
                   client.sendMessage(from, hasil, image, {quoted: mek, caption: `📍𝗥𝗲𝘀𝘂𝗹𝘁𝗮𝗱𝗼𝘀 𝗱𝗲 ${body.slice(5)} 📍`})
                   await limitAdd(sender)
                   break
                   case 'covidcountry':
                   client.updatePresence(from, Presence.composing) 
...
// recursos anime, random @nabuto domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                 infomp3 = `📍𝗠𝗨𝗦𝗜𝗖𝗔 𝗘𝗡𝗖𝗢𝗡𝗧𝗥𝗔𝗗𝗔\n📍𝗧𝗜𝗧𝗨𝗟𝗢 : ${anu.result.title}\nUrl : ${anu.result.source}\n📍𝗧𝗔𝗠𝗔𝗡𝗛𝗔𝗢 : ${anu.result.size}\n\n❗𝗔𝗚𝗨𝗔𝗥𝗗𝗘 𝗢 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗❗...`
                buffer = await getBuffer(anu.result.thumbnail)
                lagu = await getBuffer(anu.result.url_audio)
                client.sendMessage(from, buffer, image, {quoted: mek, caption: infomp3})
                client.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', filename: `${anu.title}.mp3`, quoted: mek})
