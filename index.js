...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '𝗘𝘀𝗽𝗲𝗿𝗲𝗲 𝘂𝗺 𝗽𝗼𝘂𝗰𝗼, 𝘁𝗼𝗺𝗲 𝘂𝗺 𝗰𝗮𝗳𝗲́ 𝗲𝗻𝗾𝘂𝗮𝗻𝘁𝗼 𝗶𝘀𝘀𝗼 ☕...',
					success: '️❬ ✔ ❭ Sucesso 🖤',
			...
			const premium = ["5511911219615@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("Nesse grupo, não gostamos de racismos, que isso sirva de exemplo 🚶		}, 3000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("3 𝘀𝗲𝗴𝘂𝗻𝗱𝗼𝘀...")
		}, 2000)
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("1 𝘀𝗲𝗴𝘂𝗻𝗱𝗼...\n 𝗡𝗶𝗴𝘂𝗲𝗺 𝗺𝗮𝗻𝗱𝗼𝘂 𝗻𝗮̃𝗼 𝗹𝗲𝗿 𝗮𝘀 𝗿𝗲𝗴𝗿𝗮𝘀 ¯\_(ツ)_/¯, 𝗯𝘆𝗲 𝗯𝘆𝗲")
		}, 0)
	}
		...
		case 'bpfont':
			...
			break 
				...
				uptime = process.uptime()
                    client.sendMessage(from, `𝗧𝗲𝗺𝗽𝗼 𝗱𝗲 𝗿𝗲𝘀𝗽𝗼𝘀𝘁𝗮: ${latensi.toFixed(4)} segundos\n𝗘𝘅𝗲𝗰𝘂𝗹𝘁𝗮𝗱𝗼 𝗲𝗺: PowerShell \nRAM: 8\64\n𝗦𝘁𝗮𝘁𝘂𝘀: Online\n𝗕𝗼𝘁 𝗼𝗻𝗹𝗶𝗻𝗲 𝗵𝗮:\n ${kyun(uptime)}`, text, { quoted: mek})
                    break
				case 'delete':
				case 'del':
				case 'd':  
          ...
          reply('Espere..')
			...
			reply(mess.wait)
				...
				case 'limpar':
					...
					break
				case 'bc':
					if (!isOwner) return reply('Quem é Você, não é meu dono')
					if (args.length < 1) return reply('.......')
					anu = await client.chats.all()
