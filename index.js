...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:dobby\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=556993733829:556993733829\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '!','*','.'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const premium = ["5511911219615@s.whatsapp.net","17198903218@s.whatsapp.net","12603386264@s.whatsapp.net","555196953702@s.whatsapp.net","558994528356@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (isGroupAdmins) return reply('‼️𝗟𝗶𝗻𝗸 𝗗𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼‼️\n𝗟𝗶𝗯𝗲𝗿𝗮𝗱𝗼, 𝘃𝗰 𝗲́ 𝘂𝗺 𝗮𝗱𝗺✅')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`‼️𝗟𝗶𝗻𝗸 𝗗𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼‼️\n𝗢 ${sender.split("@")[0]} 𝘀𝗲𝗿𝗮 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗼 𝗽𝗼𝗿 𝗻𝗮𝗼 𝘀𝗲𝗴𝘂𝗶𝗿 𝗮𝘀 𝗿𝗲𝗴𝗿𝗮𝘀😇\n𝗲𝘂𝗿𝗶`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 0)
	}
		...
		if (!isGroup) return
		if (!isAntiLink) return
		if (isGroupAdmins) return reply('‼️𝗪𝗮.𝗺𝗲 𝗗𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼‼️\n𝗟𝗶𝗯𝗲𝗿𝗮𝗱𝗼, 𝘃𝗰 𝗲́ 𝘂𝗺 𝗮𝗱𝗺✅')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`‼️𝗪𝗮.𝗺𝗲 𝗗𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼‼️\n𝗢 ${sender.split("@")[0]} 𝘀𝗲𝗿𝗮 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗼 𝗽𝗼𝗿 𝗻𝗮𝗼 𝘀𝗲𝗴𝘂𝗶𝗿 𝗮𝘀 𝗿𝗲𝗴𝗿𝗮𝘀 😇`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 0)
	}
		...
		if (!isGroup) return
		if (!isAntiLink) return
		if (isGroupAdmins) return reply('‼️𝗡𝘂𝗺𝗲𝗿𝗼 𝗗𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼‼️\n𝗟𝗶𝗯𝗲𝗿𝗮𝗱𝗼, 𝘃𝗰 𝗲́ 𝘂𝗺 𝗮𝗱𝗺✅')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`‼️𝗡𝘂𝗺𝗲𝗿𝗼 𝗗𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼‼️\n𝗢 ${sender.split("@")[0]} 𝘀𝗲𝗿𝗮 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗼 𝗽𝗼𝗿 𝗻𝗮𝗼 𝘀𝗲𝗴𝘂𝗶𝗿 𝗮𝘀 𝗿𝗲𝗴𝗿𝗮𝘀 😇`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 0)
	}

	        if (messagesC.includes("+1")){
		if (!isGroup) return
		if (!isAntiLink) return
		if (isGroupAdmins) return reply('‼️𝗡𝘂𝗺𝗲𝗿𝗼 𝗗𝗲𝘁𝗲𝗰𝘁𝗮𝗱𝗼‼️\n𝗟𝗶𝗯𝗲𝗿𝗮𝗱𝗼, 𝘃𝗰 𝗲́ 𝘂𝗺 𝗮𝗱𝗺✅')
		client.updatePresence(from, Presence.composing)
	...
	if (messagesC.includes("fdp")){
			client.updatePresence(from, Presence.composing)
			reply("𝗡𝗮̃𝗼 𝗼𝗳𝗲𝗻𝗱𝗮 𝘀𝗲𝘂𝘀 𝗰𝗼𝗹𝗲𝗴𝘂𝗶𝗻𝗵𝗮𝘀 𝗱𝗲 𝘇𝗮𝗽👍")
				}
	...
	if (messagesC.includes("pnc")){
		...
		if (messagesC.includes("arrombado")){
		    ...
		    client.updatePresence(from, Presence.composing)
	    	tujuh = fs.readFileSync('./assets/eude4.mp3');
	    	client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
    }           
...
MENU DESATUALISADO,ESTOU COM PREGUIÇA DE ATUALIZAR, FDS
━━━━━━━━━━━━━━━━━━🌨
...
➦${prefix}𝗯𝗲𝗶𝗷𝗼
➦${prefix}𝗹𝗼𝗹𝗶
➦${prefix}𝗯𝗼𝗾𝘂𝗲𝘁𝗲 [premium]🔞
➦${prefix}𝗵𝗲𝗻𝘁𝗮𝗶 [premium]🔞
➦${prefix}𝗻𝗲𝗸𝗼 [premium]🔞
...
case 'gerardados1':
			...
			reply('*🗿- AGUARDE UM INSTANTE FI*')
					boxx = await fetchJson(`https://pastebin.com/raw/UbxeQbtD`, {method: 'get'})
					gerftext = boxx[Math.floor(Math.random() * boxx.length)]
		            box =  `*Nome :* *${gerftext.first_name}*\n*Sobrenome :* *${gerftext.last_name}*\n*Email :* *${gerftext.email}*\n*Gênero :* *${gerftext.gender}*\n*Ip   :* *${gerftext.ip_address}*`
                   ...
                   case 'saylist':
					...
					break
				case 'texto3d':
                data = await await getBuffer(`https://docs-jojo.herokuapp.com/api/text3d?text=${body.slice(9)}`)
                client.sendMessage(from, data, image, {quoted: mek, caption: body.slice(9)})
		...
		reply(`‼️𝗧𝗔𝗚 𝗢𝗕𝗥𝗜𝗚𝗔𝗧𝗢𝗥𝗜𝗔️‼️`)
				...
				case 'neko':
                   if (!isPremium) return reply('❗𝗖𝗢𝗠𝗔𝗡𝗗𝗢 𝗘𝗫𝗖𝗟𝗨𝗦𝗜𝗩𝗢 𝗣𝗔𝗥𝗔 𝗨𝗦𝗨𝗔𝗥𝗜𝗢𝗦 𝗣𝗥𝗘𝗠𝗜𝗨𝗠𝗦❗' ,text, { quoted: mek })	
					...
					break
case 'p':
reply('𝗕𝘂𝘀𝗰𝗮𝗻𝗱𝗼 𝗺𝘂𝘀𝗶𝗰𝗮...🔎️')
res = (await fetchJson(`https://arugaytdl.herokuapp.com/search?q=${body.slice(3)}`, {method: 'get'}))[0]
...
teks = ('➸𝗠𝗨𝗦𝗜𝗖𝗔 𝗘𝗡𝗖𝗢𝗡𝗧𝗥𝗔𝗗𝗔✅\n➸𝗖𝗮𝘀𝗼 𝗻𝗮̃𝗼 𝘀𝗲𝗷𝗮 𝗮 𝗺𝘂𝘀𝗶𝗰𝗮 𝗾𝘂𝗲 𝘃𝗼𝗰𝗲̂ 𝗾𝘂𝗲𝗿𝗶𝗮, 𝘁𝗲𝗻𝘁𝗲 𝗲𝘅𝗽𝗲𝗰𝗶𝗳𝗶𝗰𝗮𝗿 𝗼 𝘁𝗶𝘁𝘂𝗹𝗼\n\n➸𝗕𝘆 𝗗𝗼𝗯𝗯𝘆☔シ')
...
case 'prei':
            ...
            .then(async (res) => {
				...
				if (afsize >= 16.0 || asize.data.filesize.endsWith('GB')) {
					...
					await client.sendFileFromUrl(from, `${res.data[0].thumbnail}`, ``, `*Título:* ${res.data[0].title}\n\n*Duração:* ${res.data[0].duration} segundos\n\nLink: https://youtu.be/${res.data[0].id}\n\n*Postado:* ${res.data[0].uploadDate}\n\n*Visualizações:* ${res.data[0].viewCount}\n\n[💽] 𝘱𝘳𝘰𝘤𝘦𝘴𝘴𝘢𝘯𝘥𝘰...`, id)
...
client.sendMessage(from, destrava(prefix), text, { quoted: mek })
client.sendMessage(from, destrava(prefix), text, { quoted: mek })
reply('𝗗𝗲𝘀𝘁𝗿𝗮𝘃𝗮𝘀 𝗲𝗻𝘃𝗶𝗮𝗱𝗮𝘀 𝗰𝗼𝗺 𝘀𝘂𝗰𝗲𝘀𝘀𝗼')
                    break
                   case 'pack':
                    if (!isPremium) return reply(mess.only.premium)
		...
		case 'iri':
			...
			break
                ...
                case 'bitext':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: body.slice(7)})
					break
                case 'iplog':
					if (!isPremium) return reply('❗𝗖𝗢𝗠𝗔𝗡𝗗𝗢 𝗘𝗫𝗖𝗟𝗨𝗦𝗜𝗩𝗢 𝗣𝗔𝗥𝗔 𝗨𝗦𝗨𝗔𝗥𝗜𝗢𝗦 𝗣𝗥𝗘𝗠𝗜𝗨𝗠𝗦❗' ,text, { quoted: mek })
                    teks = body.slice(7)
                    anu = await fetchJson(`https://mnazria.herokuapp.com/api/check?ip=${teks}`)
			        ipl = `🔎𝗖𝗢𝗡𝗦𝗨𝗟𝗧𝗔 𝗥𝗘𝗟𝗜𝗭𝗔𝗗𝗔🔎

➸𝗖𝗶𝗱𝗮𝗱𝗲: ${anu.city}
➸𝗟𝗮𝘁𝗶𝘁𝘂𝗱𝘀: ${anu.latitude}
➸𝗟𝗼𝗻𝗴𝗶𝘁𝘂𝗱𝗲: ${anu.longitude}
➸𝗥𝗲𝗴𝗶𝗮̃𝗼: ${anu.region_name}
➸𝗘𝘀𝘁𝗮𝗱𝗼: ${anu.region_code}
➸𝗜𝗣: ${anu.ip}
➸𝗧𝗶𝗽𝗼: ${anu.type}
➸𝗖𝗲𝗽: ${anu.zip}
➸𝗟𝗼𝗰𝗮𝗹𝗶𝗱𝗮𝗱𝗱: ${anu.location.geoname_id}
➸𝗖𝗮𝗽𝗶𝘁𝗮𝗹: ${anu.location.capital}
➸𝗗𝗗𝗗: ${anu.location.calling_code}
➸𝗣𝗮𝗶𝘀: ${anu.location.country_flag_emoji}
...
𝗕𝘆 𝗗𝗼𝗯𝗯𝘆 シ︎`
				...
				encode32 = `${body.slice(10)}`
					...
					break
case 'neon':
                data = await await getBuffer(`https://api.zeks.xyz/api/bneon?apikey=apivinz&text=${body.slice(6)}`)
                client.sendMessage(from, data, image, {quoted: mek, caption: body.slice(6)})
                await limitAdd(sender)
                break
                case 'gtext':
				...
				break
case 'litext111':
                data = await await getBuffer(`https://api.zeks.xyz/api/tlight?text=${body.slice(8)}&apikey=apivinz}`)
...
case 'litext':
					...
					teks = body.slice(8)
					if (teks.length > 15) return reply('O texto é longo, até 15 caracteres')
					buffer = await getBuffer(`https://api.zeks.xyz/api/tlight?text=${body.slice(8)}&apikey=apivinz}`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: ''})
					break
				case 'encbinary':
...
case 'exetp':
		    		...
		    		attp2 = await getBuffer(`https://api.xteam.xyz/attp?file&text=${body.slice(7)}`)
          ...
          case 'snack':
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'water':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://zeksapi.herokuapp.com/api/tfire?text=${tels}&apikey=BotWeA`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
					break
                 case 'nomegp':
...
//@nabutoYT					
    ...
    break
				...
				case 'yt':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.arugaz.my.id/api/media/ytsearch?query=${body.slice(4)}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = '=================\n'
					for (let i of anu.result) {
						teks += `\`\`\`Título\`\`\` : *${i.title}*\n\`\`\`Link\`\`\` : *https://youtu.be/${i.id}*\n\`\`\`Publicados\`\`\` : *${i.uploadDate}*\n\`\`\`Duração\`\`\` : *${i.duration}*\n\`\`\`Visualizadores: \`\`\`*${h2k(i.viewCount)}*\n\`\`\`Canal:\`\`\` *${i.channel.name}*\n=================\n`
...
case 'skilo':
					...
					exec(`ffmpeg -i ${media} -filter:a "atempo=1.0,asetrate=65100" ${buz}`, (err, stderr, stdout) => {
						fs.unlinkSync(media)
						if (err) return reply('𝗜𝗺𝗽𝗼𝘀𝘀𝗶𝘃𝗲𝗹 𝗮𝗱𝗶𝗰𝗶𝗼𝗻𝗮𝗿 𝗺𝗮𝗶𝘀 𝗲𝗳𝗲𝗶𝘁𝗼𝘀')
			...
			case 'slow':
                ...
                case 'lionlogo':
                      ...
                      gl1 = gh.split("|")[0];
                      reply(mess.wait)
                      anu = await fetchJson(`https://api.fdci.se/rep.php?gambar=$`, {method: 'get'})
                      buff = await getBuffer(anu.result)
                      client.sendMessage(from, buff, image, {quoted: mek})
                      break
					break
		...
		case 'bpfont':
			...
			break 
				...
				uptime = process.uptime()
                    client.sendMessage(from, `🌨️𝗠𝗶𝗻𝗵𝗮 𝗩𝗲𝗹𝗼𝗰𝗶𝗱𝗮𝗱𝗲 𝗱𝗲 𝗿𝗲𝘀𝗽𝗼𝘀𝘁𝗮 𝗲𝘀𝘁𝗮 𝗲𝗺:\n${latensi.toFixed(4)} 𝗦𝗲𝗴𝘂𝗻𝗱𝗼𝘀\n🌨️𝗘𝘀𝘁𝗼𝘂 𝗼𝗻𝗹𝗶𝗻𝗲 𝗱𝘂𝗿𝗮𝗻𝘁𝗲:\n${kyun(uptime)}😇`, text, { quoted: mek})
                    break
				case 'delete':
				case 'del':
				case 'd':  
           ...
           case 'playmp3':
            ...
            case 'smule':
				...
				case 'ttp':
					...
					anu = await fetchJson(`https://mhankbarbar.tech/api/text2image?text=${teks}&apiKey=${apibarbar}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
...
break
           ...
           reply('h')
		   hasil = `𝗖𝗮𝗹𝗰𝘂𝗹𝗮𝗻𝗱𝗼 𝘃𝗶𝗮𝗱𝗮𝗴𝗲𝗺n\n\n\n\n‍𝗢 ${gay} 𝗲́ ${anu.persen}% 𝗴𝗮𝘆🏳️‍🌈🥵`
		   reply(hasil)
		   await limitAdd(sender)
					break
                case 'nangis':
...
📌 BY: DARK BOT `
					...
					break
case 'play123':
            if (args.length == 1) return client.reply(from, 'Você usou incorretamente, digita a música.', id)
            anu = await fetchJson(`https://arugaytdl.herokuapp.com/search?q=${body.slice(6)}`)
            .then(async (res) => {
				const asize = qute9 = await getBuffer (`http://st4rz.herokuapp.com/api/yta?url=http://youtu.be/${res.data}`)
				const afsize = asize.data.filesize.replace(' MB', '')
				console.log(afsize)
				if (afsize >= 16.0 || asize.data.filesize.endsWith('GB')) {
					client.reply(from, `Desculpe, para evitar banimentos do WhatsApp, o limite de envio de audios é de 16MB, e esse possui ${asize.data.filesize}.`, id)
					...
					await client.sendFileFromUrl(from, `${res.data[0].thumbnail}`, ``, `*Título:* ${res.data[0].title}\n\n*Duração:* ${res.data[0].duration} segundos\n\nLink: https://youtu.be/${res.data[0].id}\n\n*Postado:* ${res.data[0].uploadDate}\n\n*Visualizações:* ${res.data[0].viewCount}\n\n[💽] 𝘱𝘳𝘰𝘤𝘦𝘴𝘴𝘢𝘯𝘥𝘰...`, id)
					anu = await fetchJson(`http://st4rz.herokuapp.com/api/yta2?url=http://youtu.be/${res.data[0].id}`)
					.then(async(rest) => {
						var m3pa = rest.data.result
						var m3ti = rest.data.title
						await client.sendFileFromUrl(from, m3pa, '', '', id)
...
➸𝗖𝗣𝗙: ${anu.data.number}
➸𝗙𝗢𝗥𝗠𝗔𝗧𝗢: ${anu.data.number_formatted}
➸𝗦𝗧𝗔𝗧𝗨𝗦: ${anu.data.message}
...
𝗕𝘆 𝗗𝗼𝗯𝗯𝘆☔シ︎`
			...
			case 'instaimg':
				...
				case 'semoji':
					...
					anu = await fetchJson(`https://mhankbarbars.herokuapp.com/api/emoji2png?emoji=${teks}&apikey={apibarbar}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(mess.error.stick)
...
break
				...
				case 'wibu':
					...
					break
                   case 'mapa':
                   data = await fetchJson(`https://mnazria.herokuapp.com/api/maps?search=${body.slice(6)}token=40849779ec68f8351995def08ff1e2fa`)
                   hasil = await getBuffer(data.gambar)
                   client.sendMessage(from, hasil, image, {quoted: mek, caption: `•🗺️𝗥𝗲𝘀𝘂𝗹𝘁𝗮𝗱𝗼𝘀 𝗱𝗲 ${body.slice(6)} 🌍️`})
                   await limitAdd(sender)
                   break
                   case 'covidcountry':
                   client.updatePresence(from, Presence.composing) 
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'kurumi':
                 ...
                 case 'cep':
                    ...
                    kiny = `🔍𝗖𝗢𝗡𝗦𝗨𝗟𝗧𝗔 𝗥𝗘𝗔𝗟𝗜𝗭𝗔𝗗𝗔🔍\n\n➸𝗖𝗲𝗽: ${data.cep}\n\n➸𝗘𝗻𝗱𝗲𝗿𝗲𝗰̧𝗼: ${data.logradouro}\n\n➸𝗖𝗼𝗺𝗽𝗹𝗲𝗺𝗲𝗻𝘁𝗼: ${data.complemento}\n\n➸𝗕𝗮𝗶𝗿𝗿𝗼: ${data.bairro}\n\n➸𝗖𝗶𝗱𝗮𝗱𝗲: ${data.localidade}\n\n➸𝗘𝘀𝘁𝗮𝗱𝗼: ${data.uf}\n\n➸𝗗𝗗𝗗: ${data.ddd}\n\n𝗕𝘆 𝗗𝗼𝗯𝗯𝘆 シ︎`
              ...
              case 'cerpen':
               ...
               case 'puisiimg':
                ...
                case 'cnpj':
			        ...
			        cnp = `🔍𝗖𝗢𝗡𝗦𝗨𝗟𝗧𝗔 𝗥𝗘𝗔𝗟𝗜𝗭𝗔𝗗𝗔🔍\n
 ➸𝗔𝗧𝗜𝗩𝗜𝗗𝗔𝗗𝗘 𝗣𝗥𝗜𝗡𝗖𝗜𝗣𝗔𝗟: ${res.atividade_principal}
 ➸𝗗𝗔𝗧𝗔 𝗦𝗜𝗧𝗨𝗔𝗖𝗔𝗢: ${res.data_situacao}
 ➸𝗧𝗜𝗣𝗢: ${res.tipo}
 ➸𝗡𝗢𝗠𝗘: ${res.nome}
 ➸𝗘𝗦𝗧𝗔𝗗𝗢: ${res.uf}
 ➸𝗧𝗘𝗟𝗘𝗙𝗢𝗡𝗘: ${res.telefone}
 ➸𝗦𝗜𝗧𝗨𝗔𝗖𝗔𝗢: ${res.situacao}
 ➸𝗕𝗔𝗜𝗥𝗥𝗢: ${res.bairro} 
 ➸𝗥𝗨𝗔: ${res.logradouro}
 ➸𝗡𝗨𝗠𝗘𝗥𝗢: ${res.numero}
 ➸𝗖𝗘𝗣: ${res.cep}
 ➸𝗖𝗜𝗗𝗔𝗗𝗘: ${res.municipio}
 ➸𝗣𝗢𝗥𝗧𝗘: ${res.porte}
 ➸𝗔𝗕𝗘𝗥𝗧𝗨𝗥𝗔: ${res.abertura}
 ➸𝗡𝗔𝗧𝗨𝗥𝗘𝗭𝗔 𝗝𝗨𝗥𝗜𝗗𝗜𝗖𝗔: ${res.natureza_juridica}
 ➸𝗙𝗔𝗡𝗧𝗔𝗦𝗜𝗔: ${res.fantasia}
 ➸𝗖𝗡𝗣𝗝: ${res.cnpj}
 ➸𝗨𝗟𝗧𝗠𝗔 𝗔𝗧𝗨𝗔𝗟𝗜𝗭𝗔𝗖𝗔𝗢: ${res.ultima_atualizacao}
 ➸𝗦𝗧𝗔𝗧𝗨𝗦 ${res.status}
 ➸𝗖𝗢𝗠𝗣𝗟𝗘𝗠𝗘𝗡𝗧𝗢 ${res.complemento}
 ➸𝗘𝗠𝗔𝗜𝗟 ${res.email}\n\n𝗕𝘆 𝗗𝗼𝗯𝗯𝘆 シ︎
`
			        reply(cnp)
					break					
          ...
          reply('Espere..')
				...
				case 'stiker':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						const media = await client.downloadAndSaveMediaMessage(encmedia)
						ran = getRandom('.webp')
						reply('𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗻𝗱𝗼 𝗩𝗶𝗱𝗲𝗼 𝗲𝗺 𝗳𝗶𝗴𝘂𝗿𝗶𝗻𝗵𝗮, 𝗮𝗴𝘂𝗮𝗿𝗱𝗲...')
						await ffmpeg(`./${media}`)
							.inputFormat(media.split('.')[1])
							.on('start', function (cmd) {
								console.log(`Started : ${cmd}`)
...
case 'pornhub':
			   ...
			   reply(mess.wait)
		    	...
		    	case 'grupoinfo':
		            ...
		            client.sendMessage(from, buffer, image, {quoted: mek, caption: `🔰𝗡𝗼𝗺𝗲: ${groupName}\n🔰𝗠𝗲𝗺𝗯𝗿𝗼𝘀: ${groupMembers.length}\n🔰𝗔𝗱𝗺𝘀: ${groupAdmins.length}\n🔰𝗗𝗲𝘀𝗰𝗿𝗶𝗰̧𝗮̃𝗼: ${groupDesc}`})
                    break
				case 'memes':
					reply(mess.wait)
			...
			reply(mess.wait)
				...
				case 'tstiker':
				case 'tsticker':
					if (!isNsfw) return reply('❗𝗖𝗼𝗺𝗮𝗻𝗱𝗼 𝗱𝗶𝘀𝗽𝗼𝗻𝗶𝘃𝗲𝗹 𝗮𝗽𝗲𝗻𝗮𝘀 𝗻𝗼 𝗽𝘃❗')
					if (args.length < 1) return reply('Onde está o texto, hum?')
					ranp = getRandom('.png')
					rano = getRandom('.webp')
        ...
        case 'promover':
				...
				case 'imagem':
					...
					break
				case 'bot':
					if (args.length < 1) return reply('𝗗𝗶𝗴𝗶𝘁𝗲 𝗮𝗹𝗴𝗼')
					teks = body.slice(4)
					anu = await simih(teks) //fetchJson(`https://mhankbarbars.herokuapp.com/api/samisami?text=${teks}`, {method: 'get'})
					if (anu.error) return reply('<𝗡𝗮𝗼 𝗘𝗻𝘁𝗲𝗻𝗱𝗶>')
					reply(anu)
					break
				case 'simih':
					if (!isGroup) return reply(mess.only.group)
